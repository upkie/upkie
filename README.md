...
- [PPO balancer](https://codeberg.org/upkie/ppo_balancer): legacy CPU playground to train balancing policies using Stable-Baselines3 ([video](https://www.youtube.com/shorts/bvWgYso1dzI))
