...
- **Breaking:** envs: Replace `bullet_config` dict in PyBullet backend with explicit `inertia_variation`, `joint_properties` and `torque_control` kwargs
...
- docs: Document CpuTemperature sensor
