...
- All `configure` functions now reset unspecified parameters to default values
...
- BulletInterface: Use simulation timestep from configuration dictionary
...
- Remove `upkie.config` submodule
- utils: Remove `nested_update` function
...
[unreleased]: https://github.com/upkie/upkie/compare/v5.1.0...HEAD
