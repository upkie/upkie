...
class UpkieServosTestCase(unittest.TestCase):
    """Test fixture for the UpkieServos environment."""

    def setUp(self):
        """Set up test fixture with a mock backend."""
    ...
    def test_action_space_structure(self):
        ...
        for joint_name in expected_joints:
            ...
            self.assertEqual(
                set(joint_space.spaces.keys()), expected_servo_keys
            )
    ...
    def test_spine_action_conversion(self):
        ...
        # Create test action with custom values for the left hip only
